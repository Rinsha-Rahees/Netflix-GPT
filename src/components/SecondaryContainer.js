...
const SecondaryContainer = () => {
  ...
  return (
    ...
    <div className='w-full relative h-full z-10 mt-16 md:-mt-56'>
      ...
      <MovieList title={lang[langKey].nowPlaying} movies={movies?.upcomingMovies}/>
      <MovieList title={lang[langKey].trendingMovies} movies={movies?.upcomingMovies}/>
      <MovieList title={lang[langKey].popularMovies} movies={movies?.upcomingMovies}/>
